...
{
    public class CustPaperPaymentReportController : Controller
    {
        // GET: CustPaperPaymentReport
        ApplicationDbContext db = new ApplicationDbContext();
        private CustPaperPaymentReportService CustPaperPaymentReportService;
        public CustPaperPaymentReportController()
        {
            this.CustPaperPaymentReportService = new CustPaperPaymentReportService(db);
        }
            ...
            )
        {
            ...
            return Json(CustPaperPaymentReportService.Read(FromDate, toDate
        ...
        public ActionResult Download_PDF(DateTime? FromDate, DateTime? toDate)
        {
            ...
            rd.Load(Path.Combine(Server.MapPath("~/Reports"), "CustPaperPaymentReport.rpt"));
            if (FromDate == null)
            {
                var result = (from i in db.CustPaperPayments
