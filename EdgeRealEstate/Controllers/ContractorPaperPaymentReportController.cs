...
{
    public class ContractorPaperPaymentReportController : Controller
    {
        // GET: ContractorPaperPaymentReport
        ApplicationDbContext db = new ApplicationDbContext();
        private ContractorPaperPaymentReportService ContractorPaperPaymentReportService;
        public ContractorPaperPaymentReportController()
        {
            this.ContractorPaperPaymentReportService = new ContractorPaperPaymentReportService(db);
        }
            ...
            )
        {
            ...
            return Json(ContractorPaperPaymentReportService.Read(FromDate, toDate
        ...
        public ActionResult Download_PDF(DateTime? FromDate, DateTime? toDate)
        {
            ...
            rd.Load(Path.Combine(Server.MapPath("~/Reports"), "ContractorPaperPaymentReport.rpt"));
            if (FromDate == null)
            {
                var result = (from i in db.contractorPaperPayments
