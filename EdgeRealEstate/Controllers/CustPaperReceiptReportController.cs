...
{
    public class CustPaperReceiptReportController : Controller
    {
        // GET: CustPaperReceiptReport
        ApplicationDbContext db = new ApplicationDbContext();
        private CustPaperReceiptReportService CustPaperReceiptReportService;
        public CustPaperReceiptReportController()
        {
            this.CustPaperReceiptReportService = new CustPaperReceiptReportService(db);
        }
            ...
            )
        {
            ...
            return Json(CustPaperReceiptReportService.Read( FromDate, toDate
        ...
        public ActionResult Download_PDF(DateTime? FromDate, DateTime? toDate)
        {
            ...
            rd.Load(Path.Combine(Server.MapPath("~/Reports"), "CustPaperReceiptReport.rpt"));
            if (FromDate == null)
            {
                var result = (from i in db.CustPaperReceipts
            ...
            return File(stream, "application/pdf", "تقرير سندات استلام نقدية عميل.pdf");
        }
