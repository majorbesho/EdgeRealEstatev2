...
{
    public class PricesOffersDetailsServiceForIndex
    {
        private static bool UpdateDatabase = true;
        private ApplicationDbContext db;

        public PricesOffersDetailsServiceForIndex(ApplicationDbContext db)
        {
            this.db = db;
        }

        public IList<PricesOffersDetailsViewModel> GetAllFromIndex()
        {
        ...
        public void Update(PricesOffersDetailsViewModel IRD)
        {
            if (!UpdateDatabase)
            {
                ...
                if (target != null)
                {
                    ...
                    if (IRD.PricesOffersMaster != null)
                    {
        ...
        public void updateMaster(PricesOffersMaster PricesOffersMaster)
        {
            PricesOffersMaster.isDeleted = false;
            db.Entry(PricesOffersMaster).State = EntityState.Modified;
            db.SaveChanges();
        }
    }
}